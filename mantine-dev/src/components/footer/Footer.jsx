    ...
    <footer className={classes.footer}>
      <Container className={classes.inner}>
        <div className={classes.logo}>
          <img width={200} height={200} src='https://scontent.xx.fbcdn.net/v/t1.15752-9/319050516_587940730002478_1056009518990803037_n.png?stp=dst-png_p403x403&_nc_cat=103&ccb=1-7&_nc_sid=aee45a&_nc_ohc=bNr9pL9VCc0AX94W1ze&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.xx&oh=03_AdTU6LzYDa7WxqLYCb-rRa-Txx9UAggONHWFRH1lZThzjg&oe=63F96459'>
          </img>

          <Text size="xs" color="dimmed" className={classes.description}>
            Leter du etter leverandør? Altlokalt fikser alt for deg.
          </Text>
        </div>
      ...
      <Container className={classes.afterFooter}>
        <Text color="dimmed" size="sm">
          © 2023 Altlokalt. All rights reserved.
        </Text>
