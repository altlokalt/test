...
const placeholder1 =
    'Om du leter du etter leverandør? eller du er et lokal bedrift som som ønsker å blir mer kjent, Altlokalt fikser alt for deg. Altlokal er en platform hvor du kan finne data om bedrift og "alt" i "lokalet" ditt. Fra produkter, leverandør, bedrift, jobb, arrangementer, osv, altlokals database fikse det.';
    const placeholder2 =
    'Altlokal hjelper deg med å sammenligned priser på en rekke produkter og tjenester på nett. altlokalt.no - Bli kjent i lokale og knytt kontakt direkte med lokale leverandør';
    const placeholder3 =
    'Ja, avhengig av om leverandøren har en avtale med altlokals sammedags-levering tjenneste';
    const placeholder4 =
    'Søk på altlokalt.com. Altlokalt.com gir tilgang til leverandør og bedrifter i lokalet ditt eller etter dine ønske. Medlemmer av altlokalt får direkte kontakt med leverandør og bedrifter';
    const placeholder5 =
                        ...
                        <Col span={12} md={6}>
                            ...
                            <Accordion chevronPosition="right" defaultValue="reset-password" variant="separated">
                                ...
                                <Accordion.Item className={classes.item} value="newsletter">
                                    <Accordion.Control>Levere altlokalt vare?</Accordion.Control>
